...
class TestPhaserDocsClient:
    ...
    def test_is_allowed_url_security_checks(self) -> None:
        ...
        assert not client._is_allowed_url("https://docs.phaser.io/?redirect=javascript:alert(1)")
        assert not client._is_allowed_url("https://docs.phaser.io/?data=data:text/html,<script>")
    ...
    def test_validate_search_query(self) -> None:
        ...
        with pytest.raises(ValueError, match="Search query is empty after sanitization"):
            client._validate_search_query("   ")
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_success(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
        ...
        mock_response._content = b"<html><title>Test Page</title><body>Content</body></html>"
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_http_error(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_network_error(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_timeout_error(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_retry_logic_success_after_failure(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_retry_logic_rate_limit(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_page_content(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
        """Test getting page content as DocumentationPage."""
        # Setup mock response
        html_content = "<html><title>Phaser Sprites</title><body><h1>Sprites</h1><p>Content about sprites</p></body></html>"
        mock_response = Mock()
    ...
    def test_log_security_event(self, client: PhaserDocsClient) -> None:
        ...
        with patch("phaser_mcp_server.client.logger") as mock_logger:
            client._log_security_event("TEST_EVENT", "Test details", "https://example.com")
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_with_response_validation(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_client_cleanup(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_rate_limit_max_retries(self, client: PhaserDocsClient) -> None:
        """Test rate limit handling when max retries exceeded."""
        with pytest.raises(RateLimitError, match="Rate limited after"):
            await client._handle_rate_limit(client.max_retries, "https://docs.phaser.io/test")
    ...
    @pytest.mark.asyncio
    async def test_handle_network_error_with_retry(self, client: PhaserDocsClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handle_network_error_max_retries(self, client: PhaserDocsClient) -> None:
        """Test network error handling at max retries."""
        error = Exception("Network error")
        result = await client._handle_network_error(error, client.max_retries, "TEST_ERROR")
    ...
    @pytest.mark.asyncio
    async def test_make_request_with_retry_no_client(self, client: PhaserDocsClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_make_request_with_retry_validation_error(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_make_request_with_retry_unexpected_error(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_unexpected_error(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_content_malicious_query(self, client: PhaserDocsClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_content_query_truncation(self, client: PhaserDocsClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_retry_logic_all_attempts_fail(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_retry_logic_rate_limit_then_success(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_make_request_with_retry_rate_limit_error_reraise(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_make_request_with_retry_validation_error_reraise(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_make_request_with_retry_no_last_exception(self, client: PhaserDocsClient, mock_httpx_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetch_page_validation_error_conversion(self, client: PhaserDocsClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_page_content_validation_error_conversion(self, client: PhaserDocsClient) -> None:
        """Test that ValueError from URL validation is converted to ValidationError."""
        with pytest.raises(ValidationError, match="URL cannot be empty"):
            await client.get_page_content("")

    @pytest.mark.asyncio
    async def test_search_content_validation_error_conversion(self, client: PhaserDocsClient) -> None:
